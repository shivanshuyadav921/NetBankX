...
export const RegionalTransactions: React.FC = () => {
  ...
  return (
    <div className="flex-1 flex flex-col">
      <Header
        title="Regional Traffic Journal"
        subtitle="Aggregated transaction stream flowing through Maharashtra Regional Gateway"
      />
